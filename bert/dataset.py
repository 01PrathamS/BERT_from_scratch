...
class IMDBBertDataet(Dataset): 
    ...
    MASKED_INDICES_COLUMN = 'maksed_indices' 
    ...
    def _pad_sentence(self, sentence: typing.List[str], inverse_token_mask: typing.List[bool] = None): 
        ...
        if inverse_token_mask: 
            ...
            if len_m >= self.optimal_sentence_length:
                ...
                inverse_token_mask = inverse_token_mask + [True] * (self.optimal_sentence_length - lem_m) 
...
if __name__ == "__main__": 
    ...
    ds = IMDBBertDataet(BASE_DIR.joinpath("data/imdb.csv"), ds_from=0, ds_to=50000, 
