...
from bert.dataset import IMDBBertDataet
...
class BertTrainer: 
    ...
    def __init__(self, 
        ...
        self.ml_criterion = nn.NLLoss(ignore_index=0).to(device) 
        self.optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate, weight_decay=.015)
    ...
    def train(self, epoch: int): 
        ...
        for i, value in enumerate(self.loader): 
            ...
            loss_token = self.ml_criterion(token.response(1, 2), token_target) 
